...
_current_connection: ContextVar["PoolConnectionProxy | None"] = (  # type: ignore
    ContextVar("_current_connection", default=None)
)
...
class DB:
    ...
    async def _init_connection(self, conn) -> None:  # type: ignore
    ...
    async def acquire(
        ...
        *,
    ...
    ) -> AsyncIterator["PoolConnectionProxy"]:  # type: ignore
        """
        ...
        try:
            ...
            raise ConnectionError("Database pool timeout")
    ...
    async def prepare(self, query: str, *args: Any) -> "PreparedStatement":  # type: ignore
